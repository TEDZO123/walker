...
module.exports = denz = async (denz, mek) => {
    try {
        ...
        mess = {
			...
			success: '\`\`\`⇜⇝「 𝐒𝐔𝐂𝐂𝐄𝐒 」\`\`\`',
			error: {
				stick: '\`\`\`⇜⇝「 𝐂𝐀𝐍𝐍𝐎𝐓 𝐀𝐂𝐂𝐄𝐒𝐒 𝐕𝐈𝐃𝐄𝐎𝐒! 」\`\`\`',
				Iv: '\`\`\`⇜⇝「 𝑰𝒏𝒗𝒂𝒊𝒍𝒅 𝒍𝒊𝒏𝒌 𝒕𝒓𝒚 𝒂𝒈𝒂𝒊𝒏! 」\`\`\`',
                api: '\`\`\`⇜⇝「 𝐄𝐑𝐑𝐎𝐑💔 」\`\`\`'
			},
			only: {
				group: '\`\`\`⇜⇝「 𝐎𝐍𝐋𝐘 𝐅𝐎𝐑 𝐖𝐈𝐓𝐇𝐈𝐍 𝐓𝐇𝐄 𝐆𝐑𝐎𝐔𝐏😱! 」\`\`\`',
				ownerG: '\`\`\`⇜⇝「 𝐒𝐎𝐑𝐑𝐘 𝐁𝐑𝐎 𝐎𝐍𝐋𝐘 𝐅𝐎𝐑 𝐆𝐑𝐎𝐔𝐏 𝐎𝐖𝐍𝐄𝐑𝐒🐦! 」\`\`\`',
				ownerB: '\`\`\`⇜⇝「 𝐒𝐎𝐑𝐑𝐘 𝐁𝐑𝐎 𝐎𝐍𝐋𝐘 𝐅𝐎𝐑 𝐖𝐀𝐋𝐊𝐄𝐑 𝐒𝐈𝐑🐦! 」\`\`\`',
				admin: '\`\`\`⇜⇝「 𝐎𝐍𝐋𝐘 𝐅𝐎𝐑 𝐆𝐑𝐎𝐔𝐏 𝐀𝐃𝐃𝐌𝐈𝐍𝐒! 」\`\`\`',
				Badmin: '\`\`\`⇜⇝「 𝐌𝐀𝐊𝐄 𝐓𝐇𝐄 𝐁𝐎𝐓 𝐆𝐑𝐎𝐔𝐏 𝐀𝐃𝐃𝐌𝐈𝐍 」\`\`\`'
			}
		}
		const botNumber = denz.user.jid
		const ownerNumber = [`${owner}@s.whatsapp.net`,"918590299146@s.whatsapp.net"] // ganti nomer lu
			...
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === denz.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
						denz.sendMessage(mek.key.remoteJid, `Hai\nMaaf sepertinya saat ini owner ᴀᴅɪᴛʜsᴇʀ ʙᴏᴛ sedang *offline*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan hubungi lagi setelah *10 menit*`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: fake, orderTitle: fake, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
					}
				}
						}
					}
...
console.log(e)
  ...
  const sendMediaURL = async(to, url, text="", mids=[]) =>{
		   ...
		   const sendFakeStatus = (from, teks, faketeks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `ᴡᴀʟᴋᴇʀ©™`, orderTitle: `ᴡᴀʟᴋᴇʀ©™`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
			}
			...
			if (budo === `${prefix}public`){
				publik = true
				sendFakeStatus(from, 'Done✔️', fake)
			}
			if (budo === `${prefix}self`){
				publik = false
				sendFakeStatus(from, 'Done✔️', fake)
 ...
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
			...
			for (let anji of setik){
				if (budy === anji){
					...
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 𝑺𝑲𝒀𝑳𝑰𝑵𝑬-𝑩𝑶𝑻 」 ➫➬➭ ${anji}`, orderTitle: `「 𝑺𝑲𝒀𝑳𝑰𝑵𝑬-𝑩𝑶𝑻 」➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 𝑺𝑲𝒀𝑳𝑰𝑵𝑬-𝑩𝑶𝑻 」 ➫➬➭ ${anju}`, orderTitle: `「 𝑺𝑲𝒀𝑳𝑰𝑵𝑬-𝑩𝑶𝑻 」➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 3599966860, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 𝑺𝑲𝒀𝑳𝑰𝑵𝑬-𝑩𝑶𝑻 」➫➬➭ ${anjh}`, orderTitle: `「 𝑺𝑲𝒀𝑳𝑰𝑵𝑬-𝑩𝑶𝑻 」 ➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
ucapan = ` *TicTacToe* \nGiliran @${tty.player1.split('@')[0]}\nPlayer2 @${tty.player2.split('@')[0]}\n\n${ttt}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
       ...
       const isMedia = (type === 'imageMessage' || type === 'videoMessage')
        ...
        switch (command) {
			   case 'help':
		        dtod = "917356378949@s.whatsapp.net" //jangan diganti
...
║༄ ${prefix}ʀᴜɴᴛɪᴍᴇ
║༄ ${prefix}sᴘᴇᴇᴅ
║༄ ${prefix}ᴘʀɪᴠᴀᴛᴇ ʙᴏᴛ ᴀɴɴ 
║༄ ${prefix}ᴏᴡɴᴇʀ
╚༄ ${prefix}ᴍᴇɴᴜ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ :https://instagram.com/_anees_x0
 ╚༄
╔༆*𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔༄༄༄༄༄༄
║༄ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
║༄ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ
...
${tampilUcapan}
${" "}
   ᴏɪɪ ${pushname}   sᴇʟᴇᴄᴛ ᴀ ᴍᴇɴᴜ
${""}
`,"buttonText":" 𝑪𝑳𝑰𝑪𝑲 𝑯𝑬𝑹𝑬 ","listType":"SINGLE_SELECT","sections":[{
"title":"𝑺𝑬𝑳𝑬𝑪𝑻 𝑨 𝑴𝑬𝑵𝑼","rows":[{
...
case 'owner':
                    ...
                    try {
				             pporang = fs.readFileSync('./denz.jpg')
					          ...
					          pporang = 'https://i.imgur.com/ccXp7BW.jpeg'
				}
				yuz = await getBuffer(pporang)
                    denz.sendMessage(from, {displayname: "ᴡᴀʟᴋᴇʀ©™", vcard: kontol}, MessageType.contact, { quoted: mek})
                  denz.sendMessage(from, 'ᴛʜɪs ɪs ᴍʏ ᴏᴡɴᴇʀ...ᴅᴏɴᴛ ᴍᴇssᴀɢᴇ ʜɪᴍ ғᴏʀ ғɪʟᴇ🙂',MessageType.text, { quoted: mek} )
                  ini_buffer = await getBuffer("https://i.imgur.com/ccXp7BW.jpeg")
                  denz.sendMessage(from, yuz, MessageType.image, {quoted: mek, caption: `ʜᴇʏ ${pushname}\n\n ᴀɴᴅʜᴀᴅᴀ ɴɪɴᴀᴋ ғɪʟᴇ ᴠᴇɴɴᴏ `})
                  break
case 'artimimpi':
...
case 'tahta':
				...
				break
				case 'pubg':
				if (!isOwner) return reply(from,  `Penggunaan ${prefix}pubg teks1|teks2`, mek)
				argz = arg.split("|")
...
⍟ ────────────────── ⍟`
denz.sendMessage(from, stamtus, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: 'ᴀᴅɪᴛʜsᴇʀ 𝑩𝑶𝑻', orderTitle: 'ᴀᴅɪᴛʜsᴇʀ 𝑩𝑶𝑻', sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
break
				case 'tobc':
				if (!isOwner) return reply(mess.only.ownerB)
				if (args.length < 1) return reply('Teksnya?')
...
└ ${prefix}ytmp4 [link yt] = Video`})
            ...
            break
                    ...
                    case 'play':
                            ...
                            break
                            case 'video':
                            if (args.length === 0) return reply(`Send orders *${prefix}video* _The title of the video to search for_`)
                            ...
                            try {
                                ...
                                .then((res) => {
                                    ...
                                    const captions = `❏ *PLAYmp4*\n\n❏ *Title* : ${title}\n❏ *Ext* : MP4\n❏ *Size* : ${filesizeF}\n\n_Video being sent, Please wait a few minutes_`
                                    sendMediaURL(from, thumb, captions)
                                    await sendMediaURL(from, dl_link).catch(() => reply(mess.error.api))
                                    })
			...
			case 'ping':
				...
				case 'liststicker':
					...
					nm = body.slice(7)
					if (!nm) return reply('what is the vn name??')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					vien.push(`${nm}`)
