 ...
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
			...
			for (let anji of setik){
				if (budy === anji){
					...
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 𝑻𝑶𝑿𝑰𝑪_𝑨𝑳𝑰𝑬𝑵 」 ➫➬➭ ${anji}`, orderTitle: `「 𝑻𝑶𝑿𝑰𝑪_𝑨𝑳𝑰𝑬𝑵 」➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 𝑻𝑶𝑿𝑰𝑪_𝑨𝑳𝑰𝑬𝑵 」 ➫➬➭ ${anju}`, orderTitle: `「 𝑻𝑶𝑿𝑰𝑪_𝑨𝑳𝑰𝑬𝑵 」➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 0000000, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 𝑻𝑶𝑿𝑰𝑪_𝑨𝑳𝑰𝑬𝑵 」➫➬➭ ${anjh}`, orderTitle: `「 𝑻𝑶𝑿𝑰𝑪_𝑨𝑳𝑰𝑬𝑵 」 ➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
⍟ ────────────────── ⍟`
denz.sendMessage(from, stamtus, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: 'ᴡᴀʟᴋᴇʀ©™', orderTitle: 'ᴀᴅɪᴛʜsᴇʀ 𝑩𝑶𝑻', sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
break
				case 'tobc':
				if (!isOwner) return reply(mess.only.ownerB)
				if (args.length < 1) return reply('Teksnya?')
